---
title: "고객 사이트에서 동작하는 React + Tailwind 앱 효율적으로 개발하기 (Production-Ready)"
summary: "배너 삽입 시스템을 만들고 동작시키고 개발하면서 이렇게 특수한 환경에서의 프론트엔드 개발에 대해 알아봅니다."
...
<ArticleImage
  ...
  border
>
  <span class="break-all">React Vite Plugin preamble 코드. [https://github.com/Vitejs/Vite-plugin-react/blob/main/packages/common/refresh-utils.ts](https://github.com/Vitejs/Vite-plugin-react/blob/main/packages/common/refresh-utils.ts)</span>
</ArticleImage>
