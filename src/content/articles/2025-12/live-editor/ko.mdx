...
<ArticleImage
  ...
  border
>
  <span class="break-all">React Vite Plugin preamble 코드. <a href="https://github.com/Vitejs/Vite-plugin-react/blob/main/packages/common/refresh-utils.ts">https://github.com/Vitejs/Vite-plugin-react/blob/main/packages/common/refresh-utils.ts</a></span>
</ArticleImage>
