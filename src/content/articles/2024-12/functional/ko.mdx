---
title: "[TypeScript] 함수형 로직 짜기의 필요성, 실제 적용, 그리고 한계"
summary: "타입스크립트에서 비즈니스 로직을 함수형으로 구성하는 방법에 대해 알아보고 응용까지 해봅니다. 그리고 이 방법이 정답인가에 대한 생각도 해봅니다."
...
<ArticleImage src="/content/2024-12/functional/1.png" alt="R에 대한 에러 메시지" border />
...
<ArticleImage src="/content/2024-12/functional/2.png" alt="pipe 에서 타입 잡기 1" border />

중간 단계를 만들고자 할 때에도 왠지 타입이 잘 잡힙니다.

<ArticleImage src="/content/2024-12/functional/3.png" alt="pipe에서 타입 잡기 2" border />
...
<ArticleImage src="/content/2024-12/functional/4.png" alt="인자의 요구조건을 없애는 예시" border />
...
<ArticleImage src="/content/2024-12/functional/5.png" alt="인자의 요구조건을 굳이 없애지 않는 예시" border />
