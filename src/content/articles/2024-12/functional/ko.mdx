...
<ArticleImage img={img0} alt="R에 대한 에러 메시지" border />
...
<ArticleImage img={img1} alt="pipe 에서 타입 잡기 1" border />

중간 단계를 만들고자 할 때에도 왠지 타입이 잘 잡힙니다.

<ArticleImage img={img2} alt="pipe에서 타입 잡기 2" border />
...
<ArticleImage img={img3} alt="인자의 요구조건을 없애는 예시" border />
...
<ArticleImage img={img4} alt="인자의 요구조건을 굳이 없애지 않는 예시" border />
