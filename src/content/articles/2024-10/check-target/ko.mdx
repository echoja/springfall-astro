...
<ArticleImage
  src="/content/2024-10/check-target/i1.jpg"
  width={700}
  alt="타게팅을 하는 소년"
>
  Photo by <a href="https://unsplash.com/@medion4you?utm_content=creditCopyText&utm_medium=referral&utm_source=unsplash"> Norbert Braun </a> on <a href="https://unsplash.com/photos/a-person-holding-a-baseball-bat-uU8n5LuzpTc?utm_content=creditCopyText&utm_medium=referral&utm_source=unsplash"> Unsplash </a>
</ArticleImage>
...
<ArticleImage
  ...
  width={600}
  border
  src="/content/2024-10/check-target/p1.png"
></ArticleImage>
...
<ArticleImage alt="조건 요구사항 도식화" src="/content/2024-10/check-target/p2.png"></ArticleImage>
