---
title: "타입스크립트에서 Narrowing (타입 좁히기)가 필요한 이유"
summary: "타입스크립트 세계에서 타입을 다루는 방법 중 하나인 Narrowing 에 대해 고찰해봅니다."
...
>
  Narrowing 은 넓게 퍼져있는 범위를 좀 더 좁혀나간다는 뜻입니다. 사진: [Unsplash](https://unsplash.com/ko/s/%EC%82%AC%EC%A7%84/narrowing?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText) - [Miltiadis Fragkidis](https://unsplash.com/@_miltiadis_?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText)
</ArticleImage>
...
실제로 이 기법을 효과적으로 사용하기 위해서는 경험이 조금 필요할 수 있지만, 복잡하고 어려운 타입스크립트의 세계에서 가성비가 짱인 강력한 도구라고 믿습니다. 좀 [커다란 타입스크립트 기반 웹앱을 만들 때 굉장히 유용하게 사용](/ko/article/2023-07/ts-data-structure/)될 수도 있으므로 Discriminated Unions 는 익숙해지도록 합시당.
