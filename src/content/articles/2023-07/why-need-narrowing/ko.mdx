...
<ArticleImage
  src="/content/2023-07/why-need-narrowing/i1.jpg"
  alt="좁은 골목"
  width={700}
>
  Narrowing 은 넓게 퍼져있는 범위를 좀 더 좁혀나간다는 뜻입니다. 사진: <a href="https://unsplash.com/ko/s/%EC%82%AC%EC%A7%84/narrowing?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText">Unsplash</a> - <a href="https://unsplash.com/@_miltiadis_?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText">Miltiadis Fragkidis</a>
</ArticleImage>
