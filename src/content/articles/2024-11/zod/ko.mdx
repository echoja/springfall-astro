...
import img5 from "./assets/typed.png";
...
<ArticleImage
  ...
  alt="검증하는 사진"
>
  Photo: [Unsplash](https://unsplash.com/ko/%EC%82%AC%EC%A7%84/person-holding-paper-near-pen-and-calculator-xoU52jUVUXA?utm_content=creditCopyText&utm_medium=referral&utm_source=unsplash) from [Kelly Sikkema](https://unsplash.com/ko/@kellysikkema?utm_content=creditCopyText&utm_medium=referral&utm_source=unsplash)
</ArticleImage>
...
<ArticleImage img={img4} border caption="빠른 속도로 인기를 얻는 Zod" />
...
<ArticleImage img={img5} border caption="타입이 잘 잡히는 모습" />
