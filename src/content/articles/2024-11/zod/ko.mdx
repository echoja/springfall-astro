---
title: "타입스크립트 국룰 Validation 라이브러리 Zod에 대해 알아보자"
summary: "TypeScript에서 자주 사용되는 검증 라이브러리인 Zod가 인기를 얻게 된 배경을 알아보고, 간단한 사용법도 알아봅니다."
...
<ArticleImage
  src="/content/2024-11/zod/u.jpg"
  width={700}
  alt="검증하는 사진"
>
  Photo: <a href="https://unsplash.com/ko/%EC%82%AC%EC%A7%84/person-holding-paper-near-pen-and-calculator-xoU52jUVUXA?utm_content=creditCopyText&utm_medium=referral&utm_source=unsplash"> Unsplash </a> from <a href="https://unsplash.com/ko/@kellysikkema?utm_content=creditCopyText&utm_medium=referral&utm_source=unsplash"> Kelly Sikkema </a>
</ArticleImage>
...
<ArticleImage
  src="/content/2024-11/zod/t1.png"
  width={383}
  border
...
<ArticleImage
  src="/content/2024-11/zod/t2.png"
  width={720}
  border
...
<ArticleImage
  src="/content/2024-11/zod/t3.png"
  width={683}
  border
>
  <code>json</code> 함수의 리턴 타입은 <code>Promise&lt;any&gt;</code> 입니다.
</ArticleImage>
...
<ArticleImage src="/content/2024-11/zod/graph.png" border caption="빠른 속도로 인기를 얻는 Zod" />
...
<ArticleImage src="/content/2024-11/zod/typed.png" border caption="타입이 잘 잡히는 모습" />
