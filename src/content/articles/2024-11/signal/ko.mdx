---
title: "Vanilla 자바스크립트에서 개별적인 상태 관리하기 (@preact/signals-core)"
summary: "상태 관리에 대해서 다시금 분해하여 생각해봅니다. 프론트엔드 프레임워크를 적극적으로 활용하지 못하는 상황에서 @preact/signals-core를 사용하여 상태 관리를 해봅니다."
...
import img0 from "./assets/bird.jpg";
import img1 from "./assets/head.jpg";
...
<ArticleImage
  ...
  alt="검증하는 사진"
>
  상태 관리는 머리가 아프니 귀여운 새 사진을 보면서 힐링해요. Photo: [Unsplash](https://unsplash.com/ko/%EC%82%AC%EC%A7%84/%EA%B0%88%EC%83%89-%EB%82%98%EB%AD%87%EA%B0%80%EC%A7%80%EC%97%90-%EB%85%B8%EB%9E%80%EC%83%89%EA%B3%BC-%EA%B2%80%EC%9D%80%EC%83%89-%EC%83%88-U_vKaztM0Mo?utm_content=creditCopyText&utm_medium=referral&utm_source=unsplash) from [Saketh Upadhya](https://unsplash.com/ko/@saketh_upadhya?utm_content=creditCopyText&utm_medium=referral&utm_source=unsplash)
</ArticleImage>
...
- [리액트 vs Signals, 10년이 지난 지금](https://junghan92.medium.com/%EB%A6%AC%EC%95%A1%ED%8A%B8-vs-signals-10%EB%85%84%EC%9D%B4-%EC%A7%80%EB%82%9C-%EC%A7%80%EA%B8%88-89e5c648c2e8)
- [번역: 자바스크립트 Signal의 진화](https://junghan92.medium.com/%EB%B2%88%EC%97%AD-%EC%9E%90%EB%B0%94%EC%8A%A4%ED%81%AC%EB%A6%BD%ED%8A%B8-signal%EC%9D%98-%EC%A7%84%ED%99%94-4bd6a991d2f)
