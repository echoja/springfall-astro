...
<ArticleImage
  width={500}
  src="/content/2023-09/no-func-record/record.jpg"
  alt="레코드샵"
>
  레코드샵. <a href="https://unsplash.com/ko/@kurbanova?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText"> Elza Kurbanova </a> from <a href="https://unsplash.com/ko/%EC%82%AC%EC%A7%84/f8MLY_HKwqQ?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText"> Unsplash </a>
</ArticleImage>
