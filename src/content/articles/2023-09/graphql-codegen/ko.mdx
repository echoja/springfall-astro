...
import img0 from "./assets/o.jpg";
import img1 from "./assets/gifss.gif";
import img2 from "./assets/o1.png";
import img3 from "./assets/oo.png";

<ArticleImage
  img={img0}
  alt="두렁에 빠진 차를 밀고 있는 사람들"
>
  어떻게든 빠져나가야 한다! Photo by [Aubrey Odom](https://unsplash.com/@octoberroses?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText) on [Unsplash](https://unsplash.com/photos/T1L9Q5g7eIQ?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText)
</ArticleImage>
...
이는 `__typename` 필드를 기준으로 타입을 쉽게 정리해볼 수 있단 뜻이죠. 자세한 내용은 [타입스크립트에서 Narrowing (타입 좁히기)](/ko/article/2023-07/why-need-narrowing/)가 필요한 이유를 참조해주세요.
