---
title: "[Javascript] 스크롤에 따라 부드러운 애니메이션 구현하기 (Feat. iPhone SE)"
summary: "특별한 라이브러리를 사용하지 않고, javascript를 이용하여 애플 감성 느낌의 스크롤 애니메이션 효과를 구현합니다."
...
<ArticleImage
  src="/content/2022-10/javascript-smooth-animation/i1.jpeg"
...
<ArticleImage
  src="/content/2022-10/javascript-smooth-animation/i2.jpeg"
