---
title: "draw.io(diagrams.net) 자동 배치로 효율화하기"
summary: "검증된 다이어그램 그리기 도구인 draw.io 에서 문서가 복잡해질 때 아주 유용하게 사용할 수 있는 레이아웃 배치 기능을 사용해봅니다."
createdAt: "2023-03-11"
updatedAt: "2023-03-11"
imageAlt: "레이아웃 배치 기능이 적용된 다이어그램"
category: "디자인"
locale: "ko"
---
...
<ArticleImage
  src="/content/2023-03/draw-io-auto-layout/i1.png"
  alt="화살표 연결 시작"
>
  화살표를 연결할 때에 꼭짓점이 아니라 저 <strong>파란색 화살표</strong>를 활용해야 합니다.
</ArticleImage>

연결을 마무리 지을 때에도 아래 이미지와 같이 하세요.

<ArticleImage
  src="/content/2023-03/draw-io-auto-layout/i2.png"
  alt="화살표 연결 끝"
>
  화살표가 도착할 때에도 X 점이 아니라 <strong>하늘색 테두리</strong>가 나오게끔 연결합니다.
</ArticleImage>

그렇다면, 아래와 같이 못생긴 다이어그램이 나올 겁니다.

<ArticleImage src="/content/2023-03/draw-io-auto-layout/i3.png" alt="못생긴 다이어그램" caption="못생긴 다이어그램" />

알아보기가 불가능합니다. 이걸 멋지게 바꿔봅시다. `배치 - 레이아웃 - 수직 흐름도`를 선택합니다.

<ArticleImage
  src="/content/2023-03/draw-io-auto-layout/i4.png"
...
<ArticleImage
  src="/content/2023-03/draw-io-auto-layout/i5.png"
