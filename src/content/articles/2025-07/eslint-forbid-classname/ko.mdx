---
title: "ESLint Rule: 특정 className 사용 금지하기 (바이브 코딩을 위해)"
summary: "TailwindCSS 프로젝트에서 일관된 디자인 토큰 사용을 위해 특정 className 사용을 금지하는 ESLint 규칙을 설정하는 방법에 대해 알아봅니다. 이 규칙은 LLM에게 도움이 될 수도 있습니다!"
createdAt: "2025-07-03"
updatedAt: "2025-07-03"
imageAlt: "ESlint Forbid ClassName"
category: "기술"
locale: "ko"
---
...
<ArticleImage src="/content/2025-07/eslint-forbid-classname/eslint.png" alt="ESLint" />
...
<ArticleImage
  src="/content/2025-07/eslint-forbid-classname/errors.png"
...
<ArticleImage
  src="/content/2025-07/eslint-forbid-classname/fix1.png"
  alt="Auto Fix 실행하기 전"
  caption="Auto Fix 실행하기 전"
/>

<ArticleImage
  src="/content/2025-07/eslint-forbid-classname/fix2.png"
  alt="Auto Fix 실행한 후"
...
<ArticleImage
  src="/content/2025-07/eslint-forbid-classname/so.png"
  alt="VSCode에서 ESLint: Show Output Channel 명령 실행하기"
  caption="VSCode에서 ESLint: Show Output Channel 명령 실행하기"
/>

<ArticleImage
  src="/content/2025-07/eslint-forbid-classname/so2.png"
